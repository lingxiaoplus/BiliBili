...
class FansAdapter(layoutResId: Int, data: MutableList<FansGoldListData.FansInfo>?) :
    ...
    private val levelImages = arrayOf(
        ...
        R.drawable.ic_live_rank_4,
        R.drawable.ic_live_rank_5,
        R.drawable.ic_live_rank_6,
        R.drawable.ic_live_rank_7,
        R.drawable.ic_live_rank_8,
        R.drawable.ic_live_rank_9,
        R.drawable.ic_live_rank_10
    )
